...
export function MemberBonusReviews({ username, albums = [] }: { username: string | null; albums?: Album[] }) {
  ...
  return <section className="member-archive member-bonus-reviews" data-profile-part="bonus"><div className="member-archive__heading"><div><p className="eyebrow">{"\u00c9COUTES BONUS"}</p><h2>{"Albums \u00e9cout\u00e9s en bonus."}</h2></div><small>Hors statistiques du club</small></div><div className="member-bonus-reviews__list">{ordered.map((review) => {

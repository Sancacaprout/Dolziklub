...
export function AlbumExplorer({ albums }: { albums: Album[] }) {
  ...
  const [sort, setSort] = useState<"title" | "rating" | "proposed" | "listened">("title");

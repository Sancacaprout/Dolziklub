...
type DrawMeta = { draw_number: number; participant_usernames: string[]; status: "draft" | "published" | "locked"; avoid_repeated_pairs: boolean; draw_type: "standard" | "global"; global_proposer_username: string | null; created_at: string };

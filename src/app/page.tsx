...
export default function Home() {
  ...
  return <main>
    ...
    <section className="section meme-preview"><div className="section-heading"><div><p className="eyebrow">Musée des dossiers</p><h2>Mêmes du Ziklub</h2></div><Link href="/memes">Ouvrir les archives →</Link></div><div className="meme-strip">{memes.slice(0, 4).map((meme) => <Image src={meme.src} alt={meme.alt} key={meme.id} width={500} height={500} sizes="(max-width: 700px) 45vw, 25vw" />)}</div></section>
  </main>;
}

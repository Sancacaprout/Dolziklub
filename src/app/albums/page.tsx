...
export default async function AlbumsPage() {
  ...
  return <main className="page albums-page"><LiveClubRefresh /><p className="eyebrow">LA DISCOTHÈQUE</p><h1>Les albums<br/><em>qui traînent ici.</em></h1><p className="page-lede">{synchronizedAlbums.length} albums retrouvés, avec les propositions, écoutes, avis et notes qui ont été archivés. Recherche locale, affichage grille ou liste.</p><AlbumExplorer albums={synchronizedAlbums} /></main>;
}

...
2. Configurer `NEXT_PUBLIC_SUPABASE_URL` et `NEXT_PUBLIC_SUPABASE_PUBLISHABLE_KEY` dans Vercel pour le navigateur, ainsi que `SUPABASE_SERVICE_ROLE_KEY` uniquement pour le provisionnement serveur.
